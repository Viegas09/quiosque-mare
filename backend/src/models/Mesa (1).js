...
// Obs: não é preciso declarar mesaSchema.index({ qrcodeToken: 1 }) aqui —
// o campo já tem unique: true acima, o que já cria esse índice sozinho.
// Declarar os dois gerava o aviso de "Duplicate schema index" do Mongoose.
